...
If you experience bugs or general issues with ``enedis_odoo_bridge``, please have a look
...
You can help improve ``enedis_odoo_bridge`` docs by making them more readable and coherent, or
...
or Miniconda_::
    ...
    conda create -n enedis_odoo_bridge python=3 six virtualenv pytest pytest-cov
    conda activate enedis_odoo_bridge
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/enedis_odoo_bridge.git
    cd enedis_odoo_bridge
...
#. Install |pre-commit|_::
   ...
   ``enedis_odoo_bridge`` comes with a lot of hooks configured to automatically help the
